...
var formBtn = document.querySelector('.form--login');
var signUpBtn = document.querySelector('.form--signup');
var logoutBtn = document.querySelector('.nav__el--logout');
var updateBtn = document.querySelector('.form-user-data');
var updatePsw = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour');
if (formBtn) formBtn.addEventListener('submit', function (e) {
  e.preventDefault();
...
if (updatePsw) updatePsw.addEventListener('submit', function (e) {
  e.preventDefault();
  ...
  (0, _updateSettings.updateSettings)({
    ...
    password: password,
    passwordConfirm: passwordConfirm
  }, 'password'); // console.log(document.getElementById('password-current').value);
  // console.log('click');
